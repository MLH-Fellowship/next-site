...
- [Data Fetching](/docs/basic-features/data-fetching)
...
If `fallback` is `false`, then any paths not returned by [`getStaticPaths`](/docs/basic-features/data-fetching#getstaticpaths-static-generation) will result in a **404 page**.

If `fallback` is `true`, then the behavior of [`getStaticProps`](/docs/basic-features/data-fetching#getstaticprops-static-generation) changes:
...
This is beyond the scope of our lessons, but you can learn more about `fallback: true` in [our documentation](/docs/basic-features/data-fetching#fallback-pages).
...
Take a look at our [Dynamic Routes](/docs/routing/dynamic-routes) documentation to learn more.

### Router

If you want to access the Next.js router, you can do so by importing the `useRouter` hook from `next/router`. Take a look at our [router documentation](/docs/routing/dynamic-routes) to learn more.
...
Take a look at our [Error Pages](/docs/advanced-features/custom-error-page#404-page) documentation to learn more.
