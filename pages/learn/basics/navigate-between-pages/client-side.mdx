...
You create routes as files under `pages` and use the built-in [`Link`](/docs/api-reference/next/link) component. No routing libraries are required.

You can learn more about the `Link` component [in the API reference documentation](/docs/api-reference/next/link) and routing in general [in the routing documentation](/docs/routing/introduction).
