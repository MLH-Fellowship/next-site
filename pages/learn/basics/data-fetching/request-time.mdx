...
### Using [`getServerSideProps`](/docs/basic-features/data-fetching#getserversideprops-server-side-rendering)
...
Because [`getServerSideProps`](/docs/basic-features/data-fetching#getserversideprops-server-side-rendering) is called at request time, its parameter (`context`) contains request specific parameters. You can learn more in [our documentation](/docs/basic-features/data-fetching#getserversideprops-server-side-rendering).
...
> Again, you can get in-depth information about [`getStaticProps`](/docs/basic-features/data-fetching#getstaticprops-static-generation) and [`getServerSideProps`](/docs/basic-features/data-fetching#getserversideprops-server-side-rendering) in [our documentation](/docs/basic-features/data-fetching).
