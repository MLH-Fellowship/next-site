...
Before we talk about <Link href="/docs/[[...slug]]" as="/docs/basic-features/data-fetching"><a>data fetching</a></Link>, let’s talk about one of the most important concepts in Next.js: **Pre-rendering**.
