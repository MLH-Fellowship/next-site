...
You can get in-depth information about API Routes in [our documentation](/docs/api-routes/dynamic-api-routes). But here is some essential information you should know about API Routes.

### Do Not Fetch an API Route from [`getStaticProps`](/docs/basic-features/data-fetching#getstaticprops-static-generation) or [`getStaticPaths`](/docs/basic-features/data-fetching#getstaticpaths-static-generation)
...
Next.js has the feature called **Preview Mode** which solves this problem, and it utilizes API Routes. To learn more, take a look at our [Preview Mode](/docs/advanced-features/preview-mode) documentation.
