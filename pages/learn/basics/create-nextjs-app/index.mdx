...
- An intuitive page-based routing system (with support for [dynamic routes](/docs/routing/dynamic-routes))
...
- [Built-in CSS](/docs/basic-features/built-in-css-support) and [Sass support](/docs/basic-features/built-in-css-support#sass-support), and support for any CSS-in-JS library
...
>
> If you’re looking for the Next.js documentation instead, [click here](/docs/getting-started).
