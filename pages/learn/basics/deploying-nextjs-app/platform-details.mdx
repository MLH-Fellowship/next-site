...
- **Environment Variables:** You can also set environment variables on <PlatformText />. Take a look at <PlatformLink href="/docs/v2/build-step#environment-variables">our documentation</PlatformLink> here. You can then [use those environment variables](/docs/api-reference/next.config.js/environment-variables) in your Next.js app.
