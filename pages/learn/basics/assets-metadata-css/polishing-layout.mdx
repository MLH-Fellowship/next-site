...
So far, we’ve only added minimal React and CSS code just to illustrate concepts such as CSS Modules. Before we move on to our next lesson ([data fetching](/docs/basic-features/data-fetching)), let’s polish our page styling and code.
