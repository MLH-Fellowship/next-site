...
So far, we’ve only added minimal React and CSS code just to illustrate concepts such as CSS Modules. Before we move on to our next lesson (<Link href="/docs/[[...slug]]" as="/docs/basic-features/data-fetching"><a>data fetching</a></Link>), let’s polish our page styling and code.
