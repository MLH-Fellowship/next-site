...
The `public` directory is also useful for `robots.txt`, Google Site Verification, and any other static assets. Check out the [static file serving documentation](/docs/basic-features/static-file-serving) to learn more.
