...
> To learn more about `next/head`, check out [the API reference documentation](/docs/api-reference/next/head).
>
> If you want to customize the `<html>`, for example to add the `lang` attribute, you can do so by creating a custom `Document` component. Learn more in [the custom document documentation](/docs/advanced-features/custom-document).
