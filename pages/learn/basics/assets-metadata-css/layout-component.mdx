...
> **Important:** To use [CSS Modules](https://github.com/css-modules/css-modules), the CSS file name must end with `.module.css`.
...
This is what [CSS Modules](https://github.com/css-modules/css-modules) does: _It automatically generates unique class names_. As long as you use [CSS Modules](https://github.com/css-modules/css-modules), you don’t have to worry about class name collisions.

Furthermore, Next.js’s code splitting feature works on [CSS Modules](https://github.com/css-modules/css-modules) as well. It ensures the minimal amount of CSS is loaded for each page. This results in smaller bundle sizes.

[CSS Modules](https://github.com/css-modules/css-modules) are extracted from the JavaScript bundles at build time and generate `.css` files that are loaded automatically by Next.js.
